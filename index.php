...
if(isset($_POST['scan'])){
  $id=$_POST['id'];
header("location:files/scan.php?id=".$id."");
}
?>
      ...
      <nav class="navbar navbar-expand-lg navbar-light " style="background-color: black">
         ...
         <div class="container">
            <a class="navbar-brand" href="#">
              ...
              STUDENT ATTENDANCE <BR>MANAGEMENT SYSTEM USING BARCODE
               </h2>
            </a>
            <br><br><br>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
               ...
               <nav class="navbar navbar-light">
                  <form class="form-inline">
                     ...
                     <a href="files/view.php" class="btn btn-outline-warning" style="color: #fff;">View all<br/> Attendance</a>
                       <a href="files/add-student.php" class="btn btn-outline-warning" style="color: #fff;">Add Student</a>
                         <a href="files/view-student.php" class="btn btn-outline-warning" style="color: #fff;">View Student</a>
                  </form>
               </nav>
            </div>
         </div>
                  ...
                  <div class="card" style="border-top: 4px solid orange;border-bottom: 4px solid orange;border-radius: 4px;">
                     ...
                     <div class="card-body">
                        <div class="input-group input-group-lg">
                           ...
                           <input type="text" class="btn-block btn-lg" name="id" aria-describedby="sizing-addon1" placeholder="Enter id and scan" required="required" />
                        </div>
                         <div class="input-group input-group-lg">
                           <span class="input-group-addon" id="sizing-addon1"><img src="icon/users.ico"></span>
                           <input type="submit" class="btn btn-warning btn-block btn-lg" name="scan" value="Scan Barcode" aria-describedby="sizing-addon1" required="" />
                        </div>
                        <br>
