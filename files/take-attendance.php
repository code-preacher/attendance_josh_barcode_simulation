...
$t=date("h:i:s A",strtotime("+0 HOURS"));
 $dt=date("d-m-Y");
mysqli_query($con,"insert into attendance(name,matno,timein,date) values('$n','$mt','$t','$dt') ");
$_SESSION['msg']=" <div class='alert alert-success hide alert-dismissible fade show' role='alert'><strong>"."Attendance was successfully taken!";
header("location:../index.php");
}
else{
 $_SESSION['msg']=" <div class='alert alert-danger hide alert-dismissible fade show' role='alert'><strong>"."Error taking Attendance!";   
}
?>
    ...
    <div class="col-lg-6">
         <div class="form-group">
                                    <form action="#" method="POST">
                                            ...
                                            <input type="text" class="form-control input-rounded" value="<?php echo $rd['name']; ?>" placeholder="<?php echo $rd['name']; ?>" required="required">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Student Matriculation Number :</p>
                                            <input class="form-control input-rounded" value="<?php echo $rd['matno']; ?>"  placeholder="<?php echo $rd['matno']; ?>" required="required" >
                                        </div>
                                        <div class="form-group">
